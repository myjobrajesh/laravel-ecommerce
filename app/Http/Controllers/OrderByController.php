...
class OrderByController extends ProductsController {
    ...
    public function productsPriceHighest($id, Product $product) {
        ...
        return view('shop.category.show', ['products' => $products], compact('categories', 'category', 'brands', 'search', 'count', 'cart_count'));
    }
    ...
    public function productsPriceHighestBrand($id, Product $product) {
        ...
        return view('shop.brand.show', ['products' => $products], compact('brands', 'brand', 'category', 'search', 'count', 'cart_count'));
    }
    ...
    public function productsPriceLowestBrand($id, Product $product) {
        ...
        return view('shop.brand.show', ['products' => $products], compact('brands', 'category', 'brand', 'search', 'count', 'cart_count'));
    }
