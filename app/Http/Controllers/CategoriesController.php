...
class CategoriesController extends Controller {
    ...
    public function addPostCategories(CategoryRequest $request) {
        ...
        /*if (Auth::user()->id == 2) {
          ...
          */
            ...
            \CommonHelper::flash()->success('Success', 'Category added successfully!');
        //}

        // Redirect back to Show all categories page.
        return redirect()->route('admin.shop.category.show');
    }
    ...
    public function updateCategories($id, CategoryRequest $request) {
        ...
        /*if (Auth::user()->id == 2) {
          ...
          */
            ...
            // Flash a success message
            \CommonHelper::flash()->success('Success', 'Category updated successfully!');
        //}
    ...
    public function deleteCategories($id) {
        ...
        if ($sub_category > 0) {
            ...
            \CommonHelper::flash()->customErrorOverlay('Error', 'There are sub-categories under this parent category. Cannot delete this category until all sub-categories under this parent category are deleted');
        } /*elseif (Auth::user()->id == 2) {
            // If user is a test user (id = 2),display message saying you cant delete if your a test user
            \CommonHelper::flash()->error('Error', 'Cannot delete Category because you are signed in as a test user.');
        } */else {
            $delete->delete();
        }
    ...
    public function addPostSubCategories($id, CategoryRequest $request) {
        ...
        /*if (Auth::user()->id == 2) {
            // If user is a test user (id = 2),display message saying you cant delete if your a test user
            \CommonHelper::flash()->error('Error', 'Cannot create Sub-Category because you are signed in as a test user.');
        } else {
          */
            ...
            // Flash a success message
            \CommonHelper::flash()->success('Success', 'Sub-Category added successfully!');
        //}
    ...
    public function editSubCategories($id) {
        ...
        if (!$category) {
            return redirect('admin/shop/ategories');
        }
    ...
    public function updateSubCategories($id, CategoryRequest $request) {
        ...
        /*if (Auth::user()->id == 2) {
            // If user is a test user (id = 2),display message saying you cant delete if your a test user
            \CommonHelper::flash()->error('Error', 'Cannot edit Sub-Category because you are signed in as a test user.');
        } else {
          */
            // Update the category with all the validation rules from CategoryRequest.php
            $category->update($request->all());
            ...
            // Flash a success message
            \CommonHelper::flash()->success('Success', 'Sub-Category updated successfully!');
        //}
    ...
    public function deleteSubCategories($id) {
        ...
        if ($products > 0) {
            // Flash a error overlay message
            \CommonHelper::flash()->customErrorOverlay('Error', 'There are products under this sub-category. Cannot delete this sub-category until all products under this sub-category are deleted');
        } /*elseif (Auth::user()->id == 2) {
            // If user is a test user (id = 2),display message saying you cant delete if your a test user
            \CommonHelper::flash()->error('Error', 'Cannot delete Sub-Category because you are signed in as a test user.');
        } */else {
            $delete_sub->delete();
        }
