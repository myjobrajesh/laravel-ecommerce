...
@section('content')
    ...
    <div class="container" id="admin-product-container">
        ...
        <div class="col-md-12">
            ...
            <form role="form" method="POST" action="{{ route('admin.shop.product.post') }}">
                {{ csrf_field() }}
...
@section('footer')
    ...
    <script>
        ...
        function selectAttributeVallue(name, row) {
            var html = '<tr>';
            var i = row;
            ...
            $.each(values, function(k,v) {
                html += '<option value="'+k+'_'+v+'">'+v+'</option>';
            });
            html += '</select>';
            ...
            html += '<input type="text" name="attr_price['+i+']" >';
