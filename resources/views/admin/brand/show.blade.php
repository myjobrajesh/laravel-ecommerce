...
@section('content')
    ...
    <div class="container-fluid" id="admin-brand-container">
        ...
        <a href="{{ url('admincare/shop/brands/create') }}" class="btn btn-primary">Add new Brand</a>
            <br><br>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <td class="text-center">
                        <form method="post" action="{{ route('admin.shop.brand.delete', $brand->id) }}" class="delete_form_brand">
                            {{ csrf_field() }}
                    ...
                    <td class="text-center">
                        <a href="{{ route('admin.shop.brand.edit', $brand->id) }}">
                            <i class="material-icons green-text">mode_edit</i>
                        </a>
                    </td>
                    <td class="text-center">
                        <a href="{{ route('admin.shop.brand.products', $brand->id) }}">
